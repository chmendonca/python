...
button_subtract = Button(root,text='-',padx=padx_value,pady=pady_value,command=button_subtract)
button_multiply = Button(root,text='*',padx=padx_value - 1,pady=pady_value,command=button_multiply)
button_divide = Button(root,text='/',padx=padx_value + 1,pady=pady_value,command=button_divide)
