...
button_add = Button(root,text='+',padx=padx_value - 1,pady=pady_value,command=lambda: button_click())

button_equal = Button(root,text='=',padx=padx_value * 2 + 6,pady=pady_value,command=lambda: button_click())

button_clear = Button(root,text='CLEAR',padx=padx_value * 2 - 8,pady=pady_value,command=lambda: button_click())
