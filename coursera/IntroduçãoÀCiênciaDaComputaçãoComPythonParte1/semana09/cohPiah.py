...
"""
This program is based on the final project of the course "Introdução à Ciência
 da Computação com Python - Parte 1". I've implemented an evolution on the code
 to compare the similarities between two given texts based on their linguistics
 signature.

***Disclaimer***: Besides the technical basis on the calculations, I'm not an
 expert on plagiarism and I haven't the intention to affirm that one text was
 copied or not.
 
Obs.: Part of the code was supplied by the course authors, thus some functions
 were not implemented by myself.

texto 1: Navegadores antigos tinham uma frase gloriosa:"Navegar é preciso; viver não é preciso". Quero para mim o espírito [d]esta frase, transformada a forma para a casar como eu sou: Viver não é necessário; o que é necessário é criar. Não conto gozar a minha vida; nem em gozá-la penso. Só quero torná-la grande,ainda que para isso tenha de ser o meu corpo e a (minha alma) a lenha desse fogo. Só quero torná-la de toda a humanidade;ainda que para isso tenha de a perder como minha. Cada vez mais assim penso.Cada vez mais ponho da essência anímica do meu sangueo propósito impessoal de engrandecer a pátria e contribuirpara a evolução da humanidade.É a forma que em mim tomou o misticismo da nossa Raça.
