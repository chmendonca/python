# -*- coding: utf-8 -*-
"""
Chapter 9 - Classes (Ex. 9.6 - page 241)
Book: Curso Intensivo de Python
Date: 20Apr2020
Obs.: This exercise uses the exercise 9.4 as basis
"""
...
class IceCreamStand(Restaurant):
    def __init__(self,restaurant_name,cuisine_type):
        """Inicializa a classe Ice Cream Stand"""
        super().__init__(restaurant_name,cuisine_type)
        self.ice_cream_flavors = ["chocolate","strawberry","vanilla","coconut","banana"]
        
    def flavors(self):
        message = "Our top five flavors are: "
        for flavor in self.ice_cream_flavors:
            message += flavor.title() + ", "
        print (message[:-2] + "!")

i_c = IceCreamStand("CreamStore","Ice Cream")
i_c.flavors()
